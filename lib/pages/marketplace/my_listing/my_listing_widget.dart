  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ProductRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final myListingProductRecord = snapshot.data!;
                                    ...
                                    RichText(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          ...
                                          TextSpan(
                                            text: valueOrDefault<String>(
                                              myListingProductRecord.unitType,
                                              'pound',
                                            ),
                                            style: TextStyle(),
                                          ),
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          myListingProductRecord.locationCity,
                                          'None',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        dateTimeFormat("relative",
                                            myListingProductRecord.createdAt!),
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              font: GoogleFonts.inter(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed(
                                      EditListingDetailsWidget.routeName,
                                      queryParameters: {
                                        'currListing': serializeParam(
                                          widget.listingtoPost,
                                          ParamType.DocumentReference,
                                        ),
                                        'oldImageURL': serializeParam(
                                          myListingProductRecord.image,
                                          ParamType.String,
                                        ),
                                      }.withoutNulls,
                            ...
                            Stack(
                              children: [
                                if (!myListingProductRecord.isArchived)
                                  Align(
                                    alignment: AlignmentDirectional(1.0, 1.0),
                                    child: FFButtonWidget(
                                      onPressed: () async {
