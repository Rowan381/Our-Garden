            ...
            children: [
                        ...
                        builder: (context) => Container(
                          ...
                          child: Image.network(
                            valueOrDefault<String>(
                              () {
                                if (_model.uploadedFileUrl_uploadData0yt !=
                                        '') {
                                  return _model.uploadedFileUrl_uploadData0yt;
                        ...
                        onPressed: () async {
                          ...
                          if ((await getPermissionStatus(
                            ...
                            if (selectedMedia != null &&
                              ...
                              safeSetState(() =>
                                  _model.isDataUploading_uploadData0yt = true);
                              ...
                              try {
                                ...
                                _model.isDataUploading_uploadData0yt = false;
                              }
                              if (selectedUploadedFiles.length ==
                                      selectedMedia.length &&
                                  downloadUrls.length == selectedMedia.length) {
                                safeSetState(() {
                                  _model.uploadedLocalFile_uploadData0yt =
                                      selectedUploadedFiles.first;
                                  _model.uploadedFileUrl_uploadData0yt =
                                      downloadUrls.first;
                                });
                              } else {
                                safeSetState(() {});
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    context.pushNamed(LocationServicesWidget.routeName);
                  },
                  child: Container(
