...
class _UserProfileWidgetState extends State<UserProfileWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.activeUserListings = await queryProductRecordCount(
      ...
      if (_model.activeUserListings! >= 1) {
        _model.hasActiveListing = true;
        safeSetState(() {});
      } else {
        _model.hasActiveListing = false;
        safeSetState(() {});
      }
    });
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  ClipRRect(
                                                                                    ...
                                                                                    child: Image.network(
                                                                                      listViewProductRecord.image == '' ? 'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/plantculture-mltpm2/assets/krb97ghfkdfv/applogostransparent2-24.png' : listViewProductRecord.image,
                                                                                  ...
                                                                                  Padding(
                                                                                    padding: EdgeInsetsDirectional.fromSTEB(16.0, 5.0, 8.0, 5.0),
                                                                                    child: Row(
                                                                                      mainAxisSize: MainAxisSize.max,
                                                                                        ...
                                                                                        Align(
                                                                                          ...
                                                                                          child: Container(
                                                                                            ...
                                                                                            child: Align(
                                                                                              ...
                                                                                              child: Text(
                                                                                                '\$${valueOrDefault<String>(
                                                                                                  functions.displayValidPrice(valueOrDefault<double>(
                                                                        ...
                                                                        Align(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                FFButtonWidget(
                                                                              onPressed: () async {
                                                                                context.pushNamed(PostListingWidget.routeName);
                                                                              },
                                                                              text: 'Create Listing',
                                                                              options: FFButtonOptions(
                                                                                height: 40.0,
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        context
                                                                          ...
                                                                          queryParameters:
                                                                            ...
                                                                            'gardenRef':
                                                                                serializeParam(
                                                                              gridViewGardensRecord.reference,
                                                                              ParamType.DocumentReference,
                                                                            ),
                                                                          }.withoutNulls,
                                                                        );
