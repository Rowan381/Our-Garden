...
class _ReviewsPageWidgetState extends State<ReviewsPageWidget> {
  ...
  void initState() {
    ...
    // Setup the reviews query
    _model.setupReviewsQuery(widget.sellerReference!);
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      stream: UsersRecord.getDocument(widget.sellerReference!),
      builder: (context, snapshot) {
        ...
        // Access data but using it directly without variable
                ...
                children: [
                  ...
                  StreamBuilder<List<ReviewsRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      // Check for errors (including connectivity)
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, listViewIndex) {
                          // Use the record directly in the UI if needed
                          return Align(
                            alignment: AlignmentDirectional(-1.0, 0.0),
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
