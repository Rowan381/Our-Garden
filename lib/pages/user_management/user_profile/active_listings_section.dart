...
class ActiveListingsSection extends StatelessWidget {
  final dynamic model;
  const ActiveListingsSection({Key? key, required this.model})
      : super(key: key);
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Builder(
                      builder: (context) {
                        if (model.hasActiveListing == true) {
                          return Container(
                                                          ...
                                                          child: Align(
                                                            alignment:
                                                                AlignmentDirectional(
                                                                    0.0, 0.0),
                                                            child: Text(
                                                              ' 24${functions.displayValidPrice(listViewProductRecord.price ?? 0.0) ?? '0.00'}',
                                                              textAlign:
                                                                  TextAlign
                                                                      .center,
