...
class FeedbackFormWidget extends StatefulWidget {
  ...
  static String routeName = 'FeedbackForm';
  static String routePath = '/feedbackForm';
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(50.0, 12.0, 50.0, 0.0),
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(12.0),
                        child: Image.network(
                          'https://www.shakebugs.com/wp-content/uploads/2022/11/Heres-what-you-need-to-know-about-mobile-app-bugs.png',
                          height: 200.0,
                          fit: BoxFit.cover,
                        ),
                      ),
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await launchUrl(Uri(
                              scheme: 'mailto',
                              path: 'society@plantculturecorp.com',
                              query: {
