...
import '/index.dart';
import 'add_garden_task_widget.dart' show AddGardenTaskWidget;
import 'package:flutter/material.dart';

class AddGardenTaskModel extends FlutterFlowModel<AddGardenTaskWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in FloatingActionButton widget.
  List<GardenTasksRecord>? objectiveTwins1;
  // Stores action output result for [Firestore Query - Query a collection] action in FloatingActionButton widget.
  List<GardenTasksRecord>? objectiveTwins2;
  // Stores action output result for [Backend Call - Create Document] action in FloatingActionButton widget.
  GardenTasksRecord? gardenTaskInProgressRef;
