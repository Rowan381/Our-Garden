...
class _LogInPageWidgetState extends State<LogInPageWidget> {
  ...
  void initState() {
    ...
    _model.passwordFieldLogTextController ??= TextEditingController();
    _model.passwordFieldLogFocusNode ??= FocusNode();
  }
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Container(
                        width: 225.0,
                        child: TextFormField(
                          controller: _model.passwordFieldLogTextController,
                          focusNode: _model.passwordFieldLogFocusNode,
                          autofocus: false,
                          obscureText: !_model.passwordFieldLogVisibility,
                          decoration: InputDecoration(
                            labelText: 'Password',
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                            ...
                            suffixIcon: InkWell(
                              onTap: () => safeSetState(
                                () => _model.passwordFieldLogVisibility =
                                    !_model.passwordFieldLogVisibility,
                              ),
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        final user = await authManager.signInWithEmail(
                          ...
                          _model.passwordFieldLogTextController.text,
                        );
                        if (user == null) {
                          return;
                        }
