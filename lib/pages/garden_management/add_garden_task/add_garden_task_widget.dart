...
import 'add_garden_task_model.dart';
export 'add_garden_task_model.dart';

class AddGardenTaskWidget extends StatefulWidget {
  const AddGardenTaskWidget({super.key});

  static String routeName = 'addGardenTask';
  static String routePath = '/addGardenTask';

  @override
  State<AddGardenTaskWidget> createState() => _AddGardenTaskWidgetState();
}

class _AddGardenTaskWidgetState extends State<AddGardenTaskWidget> {
  late AddGardenTaskModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddGardenTaskModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<GardensRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<GardensRecord> addGardenTaskGardensRecordList = snapshot.data!;
                ...
                child: Padding(
                  ...
                  child: FloatingActionButton.extended(
                    onPressed: () async {
                      ...
                      _model.gardenCreatorRef = await queryGardensRecordOnce(
                        queryBuilder: (gardensRecord) => gardensRecord
                            ...
                            .where(
                              'gardenName',
                              isEqualTo: _model.assignGardenValue,
                            ),
                        singleRecord: true,
                      ...
                      if (_model.selectObjectiveValue == 'Custom') {
                        _model.objectiveTwins1 =
                          ...
                          queryBuilder: (gardenTasksRecord) => gardenTasksRecord
                              .where(
                                'gardenCreatorRef',
                                isEqualTo: _model.gardenCreatorRef?.reference,
                              )
                              .where(
                                'objective',
                                isEqualTo:
                        ...
                        if (_model.objectiveTwins1 != null &&
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                title:
                                    Text('Objective is not unique for garden'),
                      ...
                      var gardenTasksRecordReference =
                          GardenTasksRecord.collection.doc();
                      await gardenTasksRecordReference
                          .set(createGardenTasksRecordData(
                      ...
                      _model.gardenTaskInProgressRef =
                          GardenTasksRecord.getDocumentFromData(
                              createGardenTasksRecordData(
                              ...
                              gardenTasksRecordReference);
                      _shouldSetState = true;
                      if (_model.selectObjectiveValue == 'Custom') {
                        await _model.gardenTaskInProgressRef!.reference
                      ...
                      await _model.gardenTaskInProgressRef!.reference
                          .update(createGardenTasksRecordData(
                        gardenCreatorRef: _model.gardenCreatorRef?.reference,
                      ));
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FlutterFlowDropDown<String>(
                                controller:
                                    _model.assignGardenValueController ??=
                                        FormFieldController<String>(
                                  _model.assignGardenValue ??=
                                      addGardenTaskGardensRecordList
                                          .firstOrNull?.gardenName,
                                ),
                                options: addGardenTaskGardensRecordList
                                    .map((e) => e.gardenName)
                                    .toList(),
                                onChanged: (val) => safeSetState(
                                    () => _model.assignGardenValue = val),
